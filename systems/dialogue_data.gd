...
const ELARA_DIALOGUE: Array = [
	...
	},
	{
		"id": "elara_well",
		"speaker": "엘라라",
		"text": "그래, 그 얘기가 궁금하겠지. 요 며칠 마을이 영 어수선하지 않은가 — 자네도 저기 우물가에 사람들 모여 있는 거 보였겠지.",
	...
	},
	{
		...
		"speaker": "엘라라",
		"text": "사흘 전 밤 얘기일세. 정확히는 자정이 막 지났을 무렵이었지. 온 마을이 짧게, 하지만 분명하게 흔들렸어. 자다가 벌떡 깬 사람이 한둘이 아니었네. 나도 그랬고.",
		"is_decisive": false,
	...
	},
	{
		"id": "elara_well_light",
		"speaker": "엘라라",
		"text": "그리고 그 직후에, 저 동굴 쪽 하늘이 잠깐 이상한 빛으로 물들었다더군. 나는 못 봤네만, 그날 늦게까지 안 자고 있던 사람 몇이 봤다고 하더군 — 파르스름한, 이 세상 것 같지 않은 빛이었다고.",
		"is_decisive": false,
	...
	},
	{
		"id": "elara_well_dry",
		"speaker": "엘라라",
		"text": "그리고 다음 날 아침, 우물지기가 두레박을 내렸는데 바닥까지 텅 비어 있었어. 하룻밤 사이에 그리 된 거야. 이 마을이 생긴 이래로 우물이 마른 적은 단 한 번도 없었네.",
		"is_decisive": false,
		"options": [
	...
	},
	{
		"id": "elara_well_altar",
		"speaker": "엘라라",
		"text": "사실 이 동굴에 대해서는, 우리 마을에 아주 오래전부터 내려오는 이야기가 하나 있어. 자네도 저 동굴 어귀에 낡은 돌 제단 같은 게 있는 거 본 적 있나?",
		"is_decisive": false,
		"options": [
...
const ROHAN_DIALOGUE: Array = [
	...
	},
	{
		"id": "rohan_cave_5",
		"speaker": "로한",
		"text": "근데 진짜 소름 끼쳤던 건 그다음이야. 주변 짐승들이 죄다 미친 듯이 도망치기 시작했어. 새들이 한밤중에 떼로 날아오르고, 여우 한 마리는 내 앞을 그냥 지나쳐 가더군 — 나를 보고도 신경도 안 쓸 정도로. 이 숲에서 십 년 넘게 사냥했는데, 그런 반응은 처음 봤어.",
		"is_decisive": false,
		"options": [
	...
	},
	{
		...
		"speaker": "로한",
		"text": "예전? ...나도 직접 본 건 아니고, 할아버지한테 들은 얘기지만.",
		"is_decisive": false,
	...
	},
	{
		...
		"speaker": "로한",
		"text": "할아버지 말로는, 당신이 젊었을 땐 숲에 짐승이 지금보다 훨씬 많았대. 사냥감이 넘쳐서 하루에 몇 마리씩 잡아도 티도 안 났다더군. 나무도 훨씬 크고 빽빽했고.",
		"is_decisive": false,
	...
	},
	{
		...
		"speaker": "로한",
		"text": "근데 이상한 게, 그게 갑자기 그렇게 된 게 아니라는 거야. 할아버지 젊었을 때부터 지금까지, 아주 조금씩, 세대를 거치면서 줄어든 거래. 그래서 아무도 이상하다고 못 느꼈나 봐. 워낙 천천히 줄었으니까.",
		"is_decisive": false,
	...
	},
	{
		...
		"speaker": "로한",
		"narration": "(팔짱을 끼며)",
		"text": "나도 별생각 없이 흘려들었었는데... 요즘 들어 자꾸 그 얘기가 생각나. 뭔가 있는 건가, 진짜.",
		"set_flag_on_show": "heard_ancient_abundance_hint",
		"is_decisive": false,
		"options": [],
	},
...
const YUSUF_DIALOGUE: Array = [
	...
	},
	{
		...
		"options": [
			...
			{
				"label": "[그때 그 말, 계속 마음에 걸렸어요. 당신... 정확히 뭘 본 거예요?]",
				"next_id": "yusuf_secret_stage2",
				"required_affinity": {"npc_id": "yusuf", "min": 80},
				"show_if_seen": "yusuf_secret_stage1c",
				"show_if_not_seen": "yusuf_secret_stage2j",
				"show_if_flag": "guardian_event_done",
			},
			{
				"label": "[떠돌아다니면서... 다른 마을들은 어땠어요?]",
				"next_id": "yusuf_secret_stage3_1",
				"show_if_seen": "yusuf_secret_stage2j",
			},
			{
				"label": "[선물을 준다]",
	...
	},
	{
		...
		"speaker": "유서프",
		"text": "좋아. 어차피 언젠가는 말했어야 할 이야기니까. 나는... 한때 '감시자'라고 불리는 사람들과 함께 일했어.",
		"is_decisive": false,
		"next_id": "yusuf_secret_stage2c",
	},
	{
		"id": "yusuf_secret_stage2c",
		"speaker": "유서프",
		"text": "처음 들었을 땐 나쁘지 않은 일 같았지. \"맥이 마르는 마을들을 지키는 사람들\"이라고 했거든. 결절점에 이상이 생기면 가서 살피고, 필요하면 막아준다고. 나도 그 말을 믿었어. 아니, 믿고 싶었던 것 같기도 하고.",
		"is_decisive": false,
		"options": [
			{"label": "[근데요?]", "next_id": "yusuf_secret_stage2d"},
		],
	},
	{
		"id": "yusuf_secret_stage2d",
		"speaker": "유서프",
		"text": "근데 어느 마을에서, 그 \"필터\"라는 걸 직접 봤어. 다들 그냥 오래된 장치라고 부르는 그거. 근데 그거... 장치가 아니었어.",
		"is_decisive": false,
		"next_id": "yusuf_secret_stage2f",
	},
	{
		"id": "yusuf_secret_stage2f",
		"speaker": "유서프",
		"narration": "(사이)",
		"text": "안에 사람이 있었어. 움직이지도, 말도 제대로 못 하는데 — 눈빛만은 살아있더군. 그리고 그게 괴로워하고 있다는 걸, 나는 알 수 있었어.",
		"is_decisive": false,
		"affinity_change_on_show": {"npc_id": "yusuf", "amount": 5},
		"next_id": "yusuf_secret_stage2g",
	},
	{
		"id": "yusuf_secret_stage2g",
		"speaker": "유서프",
		"text": "내가 위에 있는 사람한테 물었지. 이게 뭐냐고. 왜 이런 게 있냐고. 표정 하나 안 바뀌고 그러더군. \"원래 그런 거다. 신경 쓸 것 없다.\"",
		"is_decisive": false,
		"next_id": "yusuf_secret_stage2h",
	},
	{
		"id": "yusuf_secret_stage2h",
		"speaker": "유서프",
		"narration": "(말을 흐리다가 고개를 젓는다)",
		"text": "그 말을 듣는 순간 알았어. 저 사람들, 아무것도 막고 있는 게 아니라는 걸. ...아니, 그 다음은 나도 확신 없어. 그냥 뭔가 크게 잘못됐다는 것만 알았지.",
		"is_decisive": false,
		"next_id": "yusuf_secret_stage2e",
	},
	{
		...
		"is_decisive": false,
		"options": [
			{"label": "[그래서 지금은 뭘 하려는 거예요?]", "next_id": "yusuf_secret_stage2i"},
		],
	},
	{
		"id": "yusuf_secret_stage2i",
		"speaker": "유서프",
		"narration": "(다시 평소 말투로 돌아가려 애쓰며 살짝 웃는다)",
		"text": "글쎄. 장사나 하면서 눈치나 보고 있지, 뭐. ...근데 자네가 그 동굴에 들어갔다 나온 뒤로 물맛이 달라졌다는 소문, 나도 들었어. 그거 진짜인가?",
		"is_decisive": false,
		"next_id": "yusuf_secret_stage2j",
	},
	{
		"id": "yusuf_secret_stage2j",
		"speaker": "유서프",
		"narration": "(표정이 살짝 흔들린다)",
		"text": "...그렇군. 그럼 정말로 뭔가 바뀌고 있는 거겠지. 언젠가, 진짜 언젠가는 나도 다 말할 날이 오겠지. 지금은 아니지만.",
		"set_flag_on_show": "yusuf_partial_confession",
		"is_decisive": false,
		"options": [],
	},
	{
		"id": "yusuf_secret_stage3_1",
		"speaker": "유서프",
		"narration": "(씁쓸하게 웃는다)",
		"text": "좋은 질문은 아니군.",
		"is_decisive": false,
		"next_id": "yusuf_secret_stage3_2",
	},
	{
		"id": "yusuf_secret_stage3_2",
		"speaker": "유서프",
		"text": "거의 다... 말라 있었어. 우물이고 강이고, 죄다. 사람이 아예 안 사는 곳도 있었고, 몇 안 남아서 겨우 버티는 곳도 있었지.",
		"is_decisive": false,
		"next_id": "yusuf_secret_stage3_3",
	},
	{
		"id": "yusuf_secret_stage3_3",
		"speaker": "유서프",
		"text": "처음엔 그냥 가뭄이 심한 지역인가 보다 했어. 근데 한 곳, 두 곳, 열 곳... 가는 곳마다 똑같은 얘기를 들으니까, 이게 우연이 아니란 걸 알겠더군.",
		"is_decisive": false,
		"next_id": "yusuf_secret_stage3_4",
	},
	{
		"id": "yusuf_secret_stage3_4",
		"speaker": "유서프",
		"narration": "(목소리가 낮아진다)",
		"text": "그리고 이 마을에 왔을 때, 뭔가 달랐어. 여기는 아직... 살아있었거든. 그때 알았지. 여기가 몇 안 남은 곳 중 하나라는 걸.",
		"is_decisive": false,
		"next_id": "yusuf_secret_stage3_5",
	},
	{
		"id": "yusuf_secret_stage3_5",
		"speaker": "유서프",
		"text": "그러니까 그 동굴에서 있었던 일, 절대 가볍게 볼 일이 아니야. 어쩌면... 여기가 마지막이었을지도 몰라.",
		"set_flag_on_show": "yusuf_last_village_hint",
		"is_decisive": false,
		"options": [],
	},
]
...
const MIA_DIALOGUE: Array = [
	...
	},
	{
		...
		"is_decisive": false,
		"options": [
			{"label": "[엘라라 할머니한테 들었어. 걱정 많이 하시더라, 너희 어머니도.]", "next_id": "mia_q5"},
		],
	},
	{
		"id": "mia_q5",
...
const GUARDIAN_DIALOGUE: Array = [
	...
	},
	{
		...
		"speaker": "???",
		"text": "",
		"narration": "(형체가 위협하듯 몸을 일으키다가, 플레이어가 물러서지 않는 걸 보고 멈칫한다)",
		"is_decisive": false,
		"options": [
			{"label": "[...아프잖아. 그동안 힘들었지.]", "next_id": "guardian_peace_2"},
		],
	},
	{
		"id": "guardian_peace_2",
		"speaker": "???",
		"text": "",
		"narration": "(신음이 잠시 잦아들었다가, 다시 격하게 몸부림친다 — 아직 저항이 끝난 게 아니다)",
		"is_decisive": false,
		"options": [
	...
	},
	{
		...
		"speaker": "",
		"text": "엘라라 할머니한테 가서 얘기해야겠어. 뭐라고 설명해야 할지는 모르겠지만.",
		"is_decisive": false,
		"options": [],
	},
]
