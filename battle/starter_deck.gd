...
const DECK_LIST: Array = [
	...
	{"id": "threaten", "count": 2},         # [티어1, 잠김] 대상 공격력 디버프 (마나 2)
	{"id": "frenzy", "count": 1},           # [티어3, 잠김] 강한 자기버프 (마나 0, 체력 3 소모)
	{"id": "disable", "count": 2},          # [티어2, 잠김] 공격력+방어력 동시 디버프 (마나 4)
	{"id": "seal", "count": 1},             # [티어3, 잠김] 광역 공격력+저항 디버프 (마나 12)
	{"id": "mana_drain", "count": 2},       # [티어2, 잠김] 마법 공격 + 적 마나 흡수 (마나 3)
	{"id": "execute", "count": 2},          # [티어2, 잠김] 물리 공격, 빈사 대상에 배율 (마나 3)
	{"id": "blood_drain", "count": 2},      # [티어2, 잠김] 물리 공격 + 흡혈 (마나 3)
	{"id": "gamble_strike", "count": 1},    # [티어3, 잠김] 물리 공격, 성패가 갈리는 한 방 (마나 4)
	{"id": "haste", "count": 2},            # [티어2, 잠김] 다음 카드 1장 코스트 0 (마나 2)
]
